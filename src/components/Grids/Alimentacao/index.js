...
CardAlimentacao = ({ data }= DadosProps) => {
    const dataTime = data.horario;
    const [horarioPart, dataPart] = dataTime.split(" ");
               ...
               <Text style={styles.name}>{data.nome}</Text>
                    ...
                    <EvilIcons name="close" size={25} color="black"/>
                        ...
                        <View style={styles.boxUnder}>
                            <Text style={styles.titleInfo}>Horário:</Text>
                        </View>
                            <Text style={styles.textInfo}>{horarioPart}</Text>
                        </View>
